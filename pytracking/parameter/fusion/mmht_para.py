...
def parameters():
    ...
    params.init_samples_minimum_weight = 0.10
    ...
    # params.net = NetWithBackbone(net_path='DiMPnet_ep0001.pth.tar', use_gpu=params.use_gpu)
    params.net = NetWithBackbone(net_path='mmht_model.pth.tar', use_gpu=params.use_gpu)
