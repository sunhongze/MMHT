...
class FE108Dataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_info):
        ...
        frames = ['{base_path}/{sequence_path}/{frame:0{nz}}.{ext}'.format(base_path=self.base_path,
                                                                           ...
                                                                           nz=nz, ext=ext) for frame_num in range(start_frame + init_omit, end_frame + 1)]
    ...
    #     'startFrame': 1},
    # 
    # {'anno_path': 'ball_10fps/groundtruth_rect.txt',
    #  'endFrame': 566,
    #  'ext': 'jpg',
    #  'name': 'ball_10fps',
    #  'nz': 4,
    ...
    #  'path': 'ball_10fps/img',
    #  'startFrame': 1},
    #  {'anno_path': 'ball_15fps/groundtruth_rect.txt',
    #  'endFrame': 601,
    #  'ext': 'jpg',
    #  'name': 'ball_15fps',
    #  'nz': 4,
    ...
    #  'path': 'ball_15fps/img',
    #  'startFrame': 1},
    # {'anno_path': 'bottle_sim_obj/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'bottle_sim_obj',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'bottle_sim_obj/img',
    #  'startFrame': 1},
    # {'anno_path': 'bottle_static/groundtruth_rect.txt',
    #  'endFrame': 2301,
    #  'ext': 'jpg',
    #  'name': 'bottle_static',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'bottle_static/img',
    #  'startFrame': 1},
    # {'anno_path': 'box_illu/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'box_illu',
    #  'nz': 4,
    ...
    #  'path': 'box_illu/img',
    #  'startFrame': 1},
    # {'anno_path': 'box_sim_obj/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'box_sim_obj',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'box_sim_obj/img',
    #  'startFrame': 1},
    # {'anno_path': 'cone_illu/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'cone_illu',
    #  'nz': 4,
    ...
    #  'path': 'cone_illu/img',
    #  'startFrame': 1},
    # {'anno_path': 'cone_sim_obj/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'cone_sim_obj',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'cone_sim_obj/img',
    #  'startFrame': 1},
    # {'anno_path': 'cow_illu/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'cow_illu',
    #  'nz': 4,
    ...
    #  'path': 'cow_illu/img',
    #  'startFrame': 1},
    # {'anno_path': 'cow_texture/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'cow_texture',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'cow_texture/img',
    #  'startFrame': 1},
    # {'anno_path': 'cup_sim_obj/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'cup_sim_obj',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'cup_sim_obj/img',
    #  'startFrame': 1},
    # {'anno_path': 'dove_severe/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'dove_severe',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'dove_severe/img',
    #  'startFrame': 1},
    # {'anno_path': 'dove_static/groundtruth_rect.txt',
    #  'endFrame': 1301,
    #  'ext': 'jpg',
    #  'name': 'dove_static',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'dove_static/img',
    #  'startFrame': 1},
    # {'anno_path': 'dove_texture/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'dove_texture',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'dove_texture/img',
    #  'startFrame': 1},
    # {'anno_path': 'elephant_15fps/groundtruth_rect.txt',
    #  'endFrame': 501,
    #  'ext': 'jpg',
    #  'name': 'elephant_15fps',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'elephant_15fps/img',
    #  'startFrame': 1},
    # {'anno_path': 'elephant_severe/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'elephant_severe',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'elephant_severe/img',
    #  'startFrame': 1},
    # {'anno_path': 'fighter_10fps/groundtruth_rect.txt',
    #  'endFrame': 501,
    #  'ext': 'jpg',
    #  'name': 'fighter_10fps',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'fighter_10fps/img',
    #  'startFrame': 1},
    # {'anno_path': 'fighter_severe/groundtruth_rect.txt',
    #  'endFrame': 1401,
    #  'ext': 'jpg',
    #  'name': 'fighter_severe',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'fighter_severe/img',
    #  'startFrame': 1},
    # {'anno_path': 'giraffe_illu/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'giraffe_illu',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'giraffe_illu/img',
    #  'startFrame': 1},
    # {'anno_path': 'giraffe_severe/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'giraffe_severe',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'giraffe_severe/img',
    #  'startFrame': 1},
    # {'anno_path': 'ship_10fps/groundtruth_rect.txt',
    #  'endFrame': 551,
    #  'ext': 'jpg',
    #  'name': 'ship_10fps',
    #  'nz': 4,
    ...
    #  'path': 'ship_10fps/img',
    #  'startFrame': 1},
    # {'anno_path': 'ship_static/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'ship_static',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'ship_static/img',
    #  'startFrame': 1},
    # {'anno_path': 'star_illu/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'star_illu',
    #  'nz': 4,
    ...
    #  'path': 'star_illu/img',
    #  'startFrame': 1},
    # {'anno_path': 'star_static/groundtruth_rect.txt',
    #  'endFrame': 2401,
    #  'ext': 'jpg',
    #  'name': 'star_static',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'star_static/img',
    #  'startFrame': 1},
    # {'anno_path': 'tank_10fps/groundtruth_rect.txt',
    #  'endFrame': 501,
    #  'ext': 'jpg',
    #  'name': 'tank_10fps',
    #  'nz': 4,
    ...
    #  'path': 'tank_10fps/img',
    #  'startFrame': 1},
    # {'anno_path': 'tank_15fps/groundtruth_rect.txt',
    #  'endFrame': 701,
    #  'ext': 'jpg',
    #  'name': 'tank_15fps',
    #  'nz': 4,
    ...
    #  'path': 'tank_15fps/img',
    #  'startFrame': 1},
    # {'anno_path': 'tower_sim_obj/groundtruth_rect.txt',
    #  'endFrame': 1601,
    #  'ext': 'jpg',
    #  'name': 'tower_sim_obj',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'tower_sim_obj/img',
    #  'startFrame': 1},
    # {'anno_path': 'tower_texture/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'tower_texture',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'tower_texture/img',
    #  'startFrame': 1},
    # {'anno_path': 'truck_10fps/groundtruth_rect.txt',
    #  'endFrame': 578,
    #  'ext': 'jpg',
    #  'name': 'truck_10fps',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'truck_10fps/img',
    #  'startFrame': 1},
    # {'anno_path': 'truck_15fps/groundtruth_rect.txt',
    #  'endFrame': 701,
    #  'ext': 'jpg',
    #  'name': 'truck_15fps',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'truck_15fps/img',
    #  'startFrame': 1},
    # {'anno_path': 'turtle_static/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'turtle_static',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'turtle_static/img',
    #  'startFrame': 1},
    # {'anno_path': 'turtle_texture/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'turtle_texture',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'turtle_texture/img',
    #  'startFrame': 1},
    # {'anno_path': 'whale_texture/groundtruth_rect.txt',
    #  'endFrame': 1501,
    #  'ext': 'jpg',
    #  'name': 'whale_texture',
    #  'nz': 4,
    #  'object_class': 'animal',
    #  'path': 'whale_texture/img',
    #  'startFrame': 1},
    # ]
