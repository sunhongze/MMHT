...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        train_frames, train_anno, meta_obj_train, train_event_frames = dataset.get_frames(seq_id, train_frame_ids, seq_info_dict)
        test_frames, test_anno, meta_obj_test, test_event_frames = dataset.get_frames(seq_id, test_frame_ids, seq_info_dict)

        data = TensorDict({'train_images': train_frames,
                           'train_anno': train_anno['bbox'],
                           'train_event_stack': train_event_frames,
                           'test_images': test_frames,
                           'test_anno': test_anno['bbox'],
                           'test_event_stack': test_event_frames,
